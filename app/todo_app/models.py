...
class ToDoApp(models.Model):
    ...
    user_id = models.ForeignKey(User, on_delete=models.SET_NULL, blank=False, null=True)
    task_title = models.CharField(max_length=2000, blank=True, default="")
    task_description = models.TextField(blank=True, default="")
    task_state = models.CharField(max_length=2, choices=STAT, default="1", blank=True, null=True)
    task_due_date = models.DateField(auto_now=False, auto_now_add=False, blank=True, null=True)
